var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 4, 0, 51);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/components/FeedbackForm.svelte";

    // (27:12) <Button disabled={btnDisabled}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(27:12) <Button disabled={btnDisabled}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 29, 12, 801);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(header, file$2, 21, 4, 474);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "What are the main reasons for your ratings?");
    			add_location(input, file$2, 25, 12, 571);
    			add_location(div, file$2, 24, 8, 553);
    			add_location(form, file$2, 22, 4, 509);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [text, btnDisabled, message, handleValidation, input_input_handler];
    }
    ...
    const file$3 = "src/components/FeedbackStats.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(" out of 5");
    			add_location(p0, file$3, 6, 2, 84);
    			add_location(p1, file$3, 7, 2, 109);
    ...
    class FeedbackStats extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { count: 0, average: 1 });
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 15, 2, 400);
    			attr_dev(button, "class", "close svelte-1vaj2rf");
    			add_location(button, file$4, 16, 2, 442);
    			attr_dev(p, "class", "text");
    			add_location(p, file$4, 17, 2, 516);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$5, 30, 0, 810);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
