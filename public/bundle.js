var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 6, 0, 158);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleClick = dispatch("on-click");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 4, 0, 61);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(" out of 5");
    			add_location(p0, file$2, 6, 2, 84);
    			add_location(p1, file$2, 7, 2, 109);
    			attr_dev(div, "class", "stats svelte-1s2336y");
    			add_location(div, file$2, 5, 0, 62);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class FeedbackStats extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { count: 0, average: 1 });
